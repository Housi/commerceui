...
export const mapProduct = (product) => {
  ...
  const restProduct = {
    ...
    featuredImageCollections: [
      product.featuredImageManualCollection?.value ?? null,
      product.featuredImageAutomatedCollection?.value ?? null
    ].filter((c) => !!c),
    color: _color,
    price: _price,
  ...
  return {
    // removed full product spread here to get rid of product.images,
    // but it's also more consistent now (and maybe nanoseconds faster ;p)
    ...restProduct,
